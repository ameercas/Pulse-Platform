...
/*
        $exclude = array('admin.php', 'app-store.php', 'auth.php', 'confide.php', 'editor-form.php', 'editor-iframe.php', 'editor-link.php', 'export.php', 'global.php', 'help.php', 'i18n.php', 'timezones.php', 'javascript-editor.php', 'javascript.php', 'reminders.php', 'validation.php');
*/
