...
@section('content')
  <ul class="breadcrumb breadcrumb-page">
    ...
    <li class="active">{{ trans('global.edit_beacon') }}</li>
  </ul>

  <div class="page-header">
    <h1><i class="fa fa-dot-circle-o page-header-icon"></i> {{ trans('global.edit_beacon') }}</h1>
  </div>
...
<?php
$value = (isset($beacon->locationGroup->id)) ? json_encode(['id' => $beacon->locationGroup->id, 'text' => $beacon->locationGroup->name]) : '';
...
var optsMap = {
  zoom: {{ ($geo != NULL) ? 1 : 16; }},
  center: L.latLng([ {{ $beacon_location }} ]),
  zoomControl: false,
