...
@section('content')
    ...
    <li>{{ trans('global.data_and_analytics') }}</li>
    <li class="active">{{ trans('global.users') }}</li>
	</ul>

	<div class="page-header">
		<div class="row">
			<h1 class="col-xs-12 col-sm-4 text-center text-left-sm" style="height:32px"><i class="fa fa-envelope-o page-header-icon"></i> {{ trans('global.users') }}</h1>
