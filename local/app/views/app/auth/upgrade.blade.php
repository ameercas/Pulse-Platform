...
@section('content')
	...
	<div class="page-header">
		<div class="row">
			<h1 class="col-xs-12 col-sm-4 text-center text-left-sm"><i class="fa fa-rocket page-header-icon" style="height:28px"></i> {{ trans('admin.upgrade_title') }}</h1>

		</div>
	</div>

	<p class="lead">{{ trans('admin.upgrade_msg') }}</p>
	<a href="#/account" class="btn btn-success btn-lg">{{ trans('admin.upgrade_button') }}</a>
