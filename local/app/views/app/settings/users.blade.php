...
@section('content')
    ...
    <div class="page-header">
        <div class="row">
            <h1 class="col-xs-12 col-sm-4 text-center text-left-sm"><i class="ion-ios-people page-header-icon"></i> {{ trans('global.team_members') }}</h1>
        ...
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
            <div class="panel panel-dark widget-profile {{ $class }}">
                <div class="panel-heading">
                    <a href="#/user/{{ $sl }}">
                        <div class="widget-profile-bg-icon"><i class="ion-android-person"></i></div>
