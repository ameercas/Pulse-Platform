...
@section('content')
	<ul class="breadcrumb breadcrumb-page">
        ...
        <li class="active">{{ trans('admin.branding') }}</li>
	</ul>

	<div class="page-header">
		<h1 style="height:32px"><i class="ion-paintbucket page-header-icon"></i> {{ trans('admin.branding') }}</h1>
	</div>
...
<div class="form-group">
	...
	<label class="control-label col-lg-12">{{ $field_label }} (<a href="http://www.favicomatic.com/" target="_blank">www.favicomatic.com</a>)</label>
	<div class="col-lg-12">
