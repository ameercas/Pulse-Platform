...
@section('content')
    ...
    <div class="page-header">
        <div class="row">
            <h1 class="col-xs-12 col-sm-4 text-center text-left-sm"><i class="fa fa-rocket page-header-icon"></i> {{ trans('admin.user_plans') }}</h1>
        ...
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4 item" data-id="{{ $plan->id }}">
            <div class="panel panel-dark widget-profile {{ $class }}">
                <div class="panel-heading">
                    <div class="widget-profile-bg-icon"><i class="fa fa-rocket"></i></div>
