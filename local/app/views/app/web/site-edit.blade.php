...
@section('content')
	...
	<div id="head-wrapper">
		<ul class="breadcrumb breadcrumb-page">
			...
			<li><a href="#/web">{{ trans('global.one_pages') }}</a></li>
...
<?php } ?>
								...
								<ul class="dropdown-menu dropdown-menu-right" role="menu">
									...
									<li class="divider"></li>
									<li><a href="{{ $site->domain() }}?published" target="_blank"><i class="fa fa-external-link"></i> &nbsp; {{ trans('global.view_published_version') }}</a></li><?php /*
									<li class="divider"></li>
									<li><a href="{{ url('api/v1/site-export/download-html/' . $sl) }}"><i class="fa fa-download"></i> &nbsp; {{ trans('global.download_published_version') }}</a></li>*/ ?>
								</ul>
							</div>
