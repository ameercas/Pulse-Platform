...
if (! version_compare(phpversion(), '5.5.0', '>='))
{
	...
	$requirements[] = array(
		'success' => false,
		'msg' => 'PHP ' . phpversion() . ' - Version 5.5.x or higher is required'
	);
}
else
{
...
if (! extension_loaded('openssl'))
{
	...
	$requirements[] = array(
		'success' => false,
		'msg' => 'PHP OpenSSL is not installed'
	);
}
else
{
