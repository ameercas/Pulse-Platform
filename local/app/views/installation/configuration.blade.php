...
@endif
               ...
               <div id="smtp_settings" style="display:<?php echo (\Input::old('email_driver', 'mail') == 'smtp') ? 'block': 'none'; ?>">
                ...
                <div style="margin:20px">
                  <div class="alert alert-info">After installation you can login with <strong>info@example.com</strong> / <strong>welcome</strong>.</div>
                </div>

                <div style="margin:20px">
                  <div class="alert alert-warning">If you want to update or configure additional settings, edit the files in the <strong>/app/config/production/</strong> directory.</div>
                </div>
